...
/** Reusable middleware that enforces users are logged in and have the admin role. */
 ...
 * Admin procedure
 * 
 * If you want a query or mutation to ONLY be accessible to logged in users with the admin role, use this.
